...
{
    /// <summary>Inspector settings for a caller-owned Silero detector using ONNX Runtime or ONNX Runtime Web. Requires a supplied ONNX model.</summary>
    [AddComponentMenu("ChatdollKit/Speech Pipeline/VAD/ONNX Silero Speech Detector")]
    public class OnnxSileroSpeechDetector : SpeechDetectorComponent
    {
