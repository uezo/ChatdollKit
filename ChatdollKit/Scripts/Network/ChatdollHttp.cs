...
namespace ChatdollKit.Network
{
    public class ChatdollHttp : IDisposable
    {
        ...
        public Func<HttpRequestMessage, UniTask> BeforeRequestFunc { get; set; }
        public Func<HttpResponseMessage, UniTask> AfterRequestFunc { get; set; }
        ...
        // Get
        public async UniTask<HttpResponseMessage> GetAsync(string url, Dictionary<string, string> parameters = null, Dictionary<string, string> headers = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public async UniTask<HttpResponseMessage> PostFormAsync(string url, Dictionary<string, string> data, Dictionary<string, string> headers = null, Dictionary<string, string> parameters = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        // Post binary data
        public async UniTask<HttpResponseMessage> PostBytesAsync(string url, byte[] data, Dictionary<string, string> headers = null, Dictionary<string, string> parameters = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        // Post JSON data
        public async UniTask<HttpResponseMessage> PostJsonAsync(string url, object data, Dictionary<string, string> headers = null, Dictionary<string, string> parameters = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        // Send http request
        public async UniTask<HttpResponseMessage> SendRequestAsync(string url, HttpMethod httpMethod, HttpContent content, Dictionary<string, string> headers = null, Dictionary<string, string> parameters = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Create request
